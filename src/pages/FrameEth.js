...
export default function FrameEth() {
 ...
 Provide liquidity in the ETH/stablecoin pool on Uniswap V3 to earn fees while maintaining a delta-neutral position.                                </p>
                            </div>
                            <div className="w-72">
                                <p className="text-black text-sm  ">
                                    <span className="font-semibold text-base">Step 2 : </span>
                                    Borrow ETH via Aave to hedge exposure and eliminate directional risk.                                    
                            ...
                            <div className="w-72">
                                <p className="text-black text-sm  ">
                                    <span className="font-semibold text-base">Step 3 : </span>
                                     Automatic rebalancing based on price fluctuations to ensure stable returns with no net loss risk.                                                   
